"""
Django settings for jobcrawler project.
...
SECRET_KEY = 'django-insecure-e9k9ul4r%(37b(@fo6_@66im=w1acx@l(!zo%o6c4kb!q*vf%3'
...
WSGI_APPLICATION = 'jobcrawler.wsgi.application'
